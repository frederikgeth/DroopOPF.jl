...
![Structural reduction](assets/s1_reduced_q/size.png)
...
![Acceptance comparison](assets/s1_reduced_q/acceptance.png)
...
|---|---|---|---|---|
| [public118-load1.0-ipopt-anchor](assets/s1_reduced_q/public118-load1.0-ipopt-anchor-policy.json) | True / True | 465 / 1075 | 7.594008 / 7.59402003 | LOCALLY_SOLVED; none |
| [public118-load1.0-ipopt-flat_low](assets/s1_reduced_q/public118-load1.0-ipopt-flat_low-policy.json) | True / True | 846 / 752 | 7.59401684 / 7.59402003 | LOCALLY_SOLVED; none |
| [public118-load1.0-ipopt-flat_high](assets/s1_reduced_q/public118-load1.0-ipopt-flat_high-policy.json) | True / True | 337 / 787 | 7.59323498 / 7.59401684 | LOCALLY_SOLVED; none |
| [public118-load1.05-ipopt-anchor](assets/s1_reduced_q/public118-load1.05-ipopt-anchor-policy.json) | True / False | 320 / 2000 | 11.3874284 / — | ITERATION_LIMIT; power_balance |
| [public118-load1.05-ipopt-flat_low](assets/s1_reduced_q/public118-load1.05-ipopt-flat_low-policy.json) | False / False | 2000 / 2000 | — / — | ITERATION_LIMIT; power_balance |
| [public118-load1.05-ipopt-flat_high](assets/s1_reduced_q/public118-load1.05-ipopt-flat_high-policy.json) | False / False | 2000 / 2000 | — / — | ITERATION_LIMIT; power_balance |
| [public300-load1.0-ipopt-anchor](assets/s1_reduced_q/public300-load1.0-ipopt-anchor-policy.json) | True / True | 388 / 495 | 89.2260441 / 89.4550243 | LOCALLY_SOLVED; none |
| [public300-load1.0-ipopt-flat_low](assets/s1_reduced_q/public300-load1.0-ipopt-flat_low-policy.json) | False / False | 2000 / 2000 | — / — | ITERATION_LIMIT; power_balance |
| [public300-load1.0-ipopt-flat_high](assets/s1_reduced_q/public300-load1.0-ipopt-flat_high-policy.json) | False / False | 2000 / 2000 | — / — | ITERATION_LIMIT; power_balance, droop |
| [public300-load1.05-ipopt-anchor](assets/s1_reduced_q/public300-load1.05-ipopt-anchor-policy.json) | True / False | 1040 / 2000 | 140.953331 / — | ITERATION_LIMIT; power_balance |
| [public300-load1.05-ipopt-flat_low](assets/s1_reduced_q/public300-load1.05-ipopt-flat_low-policy.json) | True / False | 352 / 2000 | 140.954185 / — | ITERATION_LIMIT; power_balance |
| [public300-load1.05-ipopt-flat_high](assets/s1_reduced_q/public300-load1.05-ipopt-flat_high-policy.json) | True / False | 637 / 2000 | 140.954185 / — | ITERATION_LIMIT; power_balance |
| [public118-load1.0-madnlp-anchor](assets/s1_reduced_q/public118-load1.0-madnlp-anchor-policy.json) | False / True | 198 / 568 | — / 7.59402008 | LOCALLY_SOLVED; none |
| [public118-load1.0-madnlp-flat_low](assets/s1_reduced_q/public118-load1.0-madnlp-flat_low-policy.json) | False / True | 1216 / 1356 | — / 7.59402016 | LOCALLY_SOLVED; none |
| [public118-load1.0-madnlp-flat_high](assets/s1_reduced_q/public118-load1.0-madnlp-flat_high-policy.json) | False / True | 284 / 660 | — / 7.59402016 | LOCALLY_SOLVED; none |
| [public118-load1.05-madnlp-anchor](assets/s1_reduced_q/public118-load1.05-madnlp-anchor-policy.json) | False / False | 1434 / 246 | — / — | LOCALLY_SOLVED; droop |
| [public118-load1.05-madnlp-flat_low](assets/s1_reduced_q/public118-load1.05-madnlp-flat_low-policy.json) | True / True | 86 / 497 | 12.1245612 / 11.3891217 | LOCALLY_SOLVED; none |
| [public118-load1.05-madnlp-flat_high](assets/s1_reduced_q/public118-load1.05-madnlp-flat_high-policy.json) | False / False | 1215 / 737 | — / — | LOCALLY_SOLVED; droop |
| [public300-load1.0-madnlp-anchor](assets/s1_reduced_q/public300-load1.0-madnlp-anchor-policy.json) | True / True | 59 / 758 | 96.3297805 / 89.455563 | LOCALLY_SOLVED; none |
| [public300-load1.0-madnlp-flat_low](assets/s1_reduced_q/public300-load1.0-madnlp-flat_low-policy.json) | False / True | 2000 / 601 | — / 89.455563 | LOCALLY_SOLVED; none |
| [public300-load1.0-madnlp-flat_high](assets/s1_reduced_q/public300-load1.0-madnlp-flat_high-policy.json) | False / True | 412 / 423 | — / 89.4557566 | LOCALLY_SOLVED; none |
| [public300-load1.05-madnlp-anchor](assets/s1_reduced_q/public300-load1.05-madnlp-anchor-policy.json) | True / True | 232 / 345 | 149.055741 / 141.405505 | LOCALLY_SOLVED; none |
| [public300-load1.05-madnlp-flat_low](assets/s1_reduced_q/public300-load1.05-madnlp-flat_low-policy.json) | True / False | 165 / 2000 | 148.855557 / — | ITERATION_LIMIT; power_balance |
| [public300-load1.05-madnlp-flat_high](assets/s1_reduced_q/public300-load1.05-madnlp-flat_high-policy.json) | False / False | 495 / 2000 | — / — | ITERATION_LIMIT; power_balance |
