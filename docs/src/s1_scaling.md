...
![Scaling results](assets/s1_scaling/scaling.png)

| Attempt | Status | Valid | Iterations | Valid objective | Physical failures |
|---|---|---|---|---|---|
| [public118-load1.0-default](assets/s1_scaling/public118-load1.0-default-diagnostics.json) | LOCALLY_SOLVED | True | 465 | 7.594008 | none |
| [public118-load1.0-none](assets/s1_scaling/public118-load1.0-none-diagnostics.json) | LOCALLY_SOLVED | True | 317 | 7.59401684 | none |
| [public118-load1.0-gradient1](assets/s1_scaling/public118-load1.0-gradient1-diagnostics.json) | LOCALLY_SOLVED | True | 333 | 7.59401684 | none |
| [public118-load1.05-default](assets/s1_scaling/public118-load1.05-default-diagnostics.json) | LOCALLY_SOLVED | True | 320 | 11.3874284 | none |
| [public118-load1.05-none](assets/s1_scaling/public118-load1.05-none-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
| [public118-load1.05-gradient1](assets/s1_scaling/public118-load1.05-gradient1-diagnostics.json) | LOCALLY_SOLVED | True | 667 | 11.3891216 | none |
| [public300-load1.0-default](assets/s1_scaling/public300-load1.0-default-diagnostics.json) | ALMOST_LOCALLY_SOLVED | True | 388 | 89.2260441 | none |
| [public300-load1.0-none](assets/s1_scaling/public300-load1.0-none-diagnostics.json) | ALMOST_LOCALLY_SOLVED | True | 600 | 89.2260441 | none |
| [public300-load1.0-gradient1](assets/s1_scaling/public300-load1.0-gradient1-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
| [public300-load1.05-default](assets/s1_scaling/public300-load1.05-default-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
| [public300-load1.05-none](assets/s1_scaling/public300-load1.05-none-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
| [public300-load1.05-gradient1](assets/s1_scaling/public300-load1.05-gradient1-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
...
All 30 original public attempts were rechecked without rerunning the solver or modifying historical evidence. Equipment-level failure categories agree with the independent validator. See [the complete location audit](assets/s1_scaling/retained-public-failures.json).
