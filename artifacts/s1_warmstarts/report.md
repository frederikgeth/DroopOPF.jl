...
![Warm-start results](warmstarts.png)

![Stationarity histories](stationarity.png)

| Attempt | Status | Valid | Iterations | Valid objective | Physical failures |
|---|---|---|---|---|---|
| [public118-load1.0-source](public118-load1.0-source-diagnostics.json) | LOCALLY_SOLVED | True | 465 | 7.594008005 | none |
| [public118-load1.0-primal](public118-load1.0-primal-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
| [public118-load1.0-zero_dual](public118-load1.0-zero_dual-diagnostics.json) | LOCALLY_SOLVED | True | 302 | 7.593238736 | none |
| [public118-load1.0-primal_dual](public118-load1.0-primal_dual-diagnostics.json) | LOCALLY_SOLVED | True | 3 | 7.594008005 | none |
| [public118-load1.05-source](public118-load1.05-source-diagnostics.json) | LOCALLY_SOLVED | True | 320 | 11.38742842 | none |
| [public118-load1.05-primal](public118-load1.05-primal-diagnostics.json) | LOCALLY_SOLVED | False | 297 | — | droop |
| [public118-load1.05-zero_dual](public118-load1.05-zero_dual-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
| [public118-load1.05-primal_dual](public118-load1.05-primal_dual-diagnostics.json) | LOCALLY_SOLVED | True | 3 | 11.38742842 | none |
| [public300-load1.0-source](public300-load1.0-source-diagnostics.json) | ALMOST_LOCALLY_SOLVED | True | 388 | 89.22604414 | none |
| [public300-load1.0-primal](public300-load1.0-primal-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | droop |
| [public300-load1.0-zero_dual](public300-load1.0-zero_dual-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
| [public300-load1.0-primal_dual](public300-load1.0-primal_dual-diagnostics.json) | ALMOST_LOCALLY_SOLVED | True | 55 | 89.22529645 | none |
| [public300-load1.05-source](public300-load1.05-source-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
| [public300-load1.05-primal](public300-load1.05-primal-diagnostics.json) | ALMOST_LOCALLY_SOLVED | True | 491 | 140.9541114 | none |
| [public300-load1.05-zero_dual](public300-load1.05-zero_dual-diagnostics.json) | ALMOST_LOCALLY_SOLVED | True | 40 | 140.953331 | none |
| [public300-load1.05-primal_dual](public300-load1.05-primal_dual-diagnostics.json) | ITERATION_LIMIT | False | 1000 | — | power_balance, droop |
...
|---|---|---|
| 118 / demand ×1.0 | public118-load1.0-zero_dual | [Seed](public118-load1.0-seed.json) |
| 118 / demand ×1.05 | public118-load1.05-source | [Seed](public118-load1.05-seed.json) |
| 300 / demand ×1.0 | public300-load1.0-primal_dual | [Seed](public300-load1.0-seed.json) |
| 300 / demand ×1.05 | public300-load1.05-zero_dual | [Seed](public300-load1.05-seed.json) |

## Equal-total-budget comparison

![Equal total budget](equal_budget.png)

The uninterrupted stressed IEEE 300 solve uses 2000 iterations and 120 CPU seconds, matching the maximum combined budget of source plus one restart. It ends with ITERATION_LIMIT and validation=False. The source objective trace matches the shared initial portion exactly. Zero-dual warm initialization validates in 1000+40 iterations; ordinary primal restart validates in 1000+491. Saved-dual restart fails after 1000+1000. [Uninterrupted diagnostics](public300-load1.05-uninterrupted-diagnostics.json).
